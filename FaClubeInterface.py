...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame,
                                                        text="Enviar Comando", command=self.movimentar)
        ...
        self.sidebar_img.grid(row=4, column=0, padx=20, pady=10)
        ...
        self.devicename = customtkinter.CTkOptionMenu(self.connection,
                                                      values=["EPOS", "EPOS1", "EPOS2", "EPOS3", "EPOS4",
                                                            "EPOS P"], width=200)
        ...
        self.textbox.insert("0.0", "Este aplicativo foi criado para o projeto de Sistemas Embarcados do Professor Glauco\n\n"
                            + "Para utilizá-lo, selecione as especificações da conexão. Estas podem ser encontradas pelo software EPOS Studio" +
                            "Após definir a conexão, marque a quantidade de steps que deseja enviar e clique no botão" +
                            "'Enviar Comando' para enviar o comando desejado para o sistema")
    ...
    # Função para Comunicar com o Socket
    ...
    # Função para mandar coordenadas ao sistema embarcado
    def movimentar(self):
